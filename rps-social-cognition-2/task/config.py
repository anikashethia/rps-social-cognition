...
AGENTS               = ["friendly", "neutral", "rng"]
# "friendly" = high-connection agent from prior conversation
# "neutral"  = low-connection agent from prior conversation
# "rng"      = random draw control (no opponent)
...
# Both social agents play at the same difficulty so that any mentalizing
# difference is driven by connection, not by opponent sophistication.
AGENT_STRATEGY_LEVELS: Dict[str, int] = {
    "friendly": 1,  # High-connection agent; matched on difficulty with neutral
    "neutral":  1,  # Low-connection agent
...
AVATAR_PATHS: Dict[str, str] = {
    "friendly": "stimuli/avatars/avatar_friendly.png",
    "neutral":  "stimuli/avatars/avatar_neutral.png",
    "rng":      RNG_ICON_PATH,
}
